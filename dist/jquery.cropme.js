 ...
 *
 * Copyright (c) 2016 Monte J. Shaffer and contributors
...
(function( $, window, document, undefined ) {
  ...
  var PREVIEW = (
    ...
    '</div></div>'
		...
		// cropping controls
	var CONTROLS_TOP = (
'<div id="{myID}-controls-interface" class="cropMe-controls-console" style="width: 600px; border: {border}px solid {borderColor};"><form name="{myID}myForm">' +
	'<div id="{myID}-show-hide" style="display: none;">' +
		...
		'<div id="{myID}-controls" class="cropMe-row-controls" style="height: 60px; background-color: {backgroundColor};">' +
			...
			'<div class="cropMe-right-controls">		' +	
					...
					'<!-- crop info & wand //-->' +
					'<div class="cropMe-inline-control">	' +
							'<span id="{myID}-box-info" class="cropMe-imageInfo cropMe-actionable cropMe-center-top" data-status="Show/Hide details about the crop box">' +
								'<span style="font-size:80%;">' +
									'<span class="fa-stack">' +
...
//console.log(self);
		...
		fetch: function () {
				...
				newImg.onload = function() {
					...
					if(empty(self.md5))  // if we replace the image, we can just call init again ... everything built stays in place ... 
						{
				...
				return self;
					...
					if(self.options.console.showControls)
									...
									setTimeout(function() { self.$controls.css({"max-height": computeToggleHeight(self) + "px"}); }, self.options.timeout.initialHeight );
									}
...
//console.log("scaledX: "+ scaledX + " scaledY: " + scaledY + " units: "+ units);
						...
						bind: function(  ) {
								var self = this;	
										...
										self.bindConsole();
									/* BEGIN bind wheelZoom */
									//self.$elem.bind(EVENT_WHEEL,function(event){
											//	self.bindWheelZoom(event);
											//return false;
											//});	
									/* END bind wheelZoom */

									//self.$elem.bind(EVENT_KEYDOWN,function(e){						
											//self.bindCtrlZoom(e);
										// ... cntrl is prevented
										//});	
										
									/* BEGIN bind cntrlZoom */
										//$(document).keydown(function(e){
											/*
										//$(document).bind(EVENT_KEYDOWN,function(e){
										self.$elem.bind(EVENT_KEYDOWN,function(e){
												e.preventDefault();
												self.bindCtrlZoom(e);
											//return false;  // not allowing me to type ... 
											if(self.options.enable.editValues == false) { return false; }
											});	
											*/
									/* END bind cntrlZoom */
									
									/* BEGIN bind bindArrowMove */
									/*
...
//console.log("startMovePoint [alex]");
//console.log(" e: " + e + " d: " + d);
//console.log(" e.shiftKey: " + e.shiftKey + " d: " + d);
//console.log(" e.ctrlKey: " + e.ctrlKey + " d: " + d);
//console.log(" e.altKey: " + e.altKey + " d: " + d);
			var self = this; 
...
//console.log(" dx: " + dx + " dy: " + dy);
					...
					data = self.calcMovePoint(data,dx,dy,d);
		...
		calcMovePoint: function(data, dx, dy, d)	{
...
//console.log(" says " + d);
//console.log(" dx: " + dx + " dy: " + dy);
//$("#mycrop").text(self.boxAction + " -> dragPOINT dx: " + dx + ", dy: " + dy); 
// todo, this math with constraints ... 

// http://stackoverflow.com/questions/1682495/jquery-resize-to-aspect-ratio

				data = self.calcMovePoint(data,dx,dy,d);
				
				//data = makeMoves(data,dx,dy,d);
				
				//data = makeMoves(data,dx,dy,d.charAt(0));  // n, s, e, w
				//data = makeMoves(data,dx,dy,d.charAt(1));  // ne is n at (0) and e at (1)
			...
			//var data = getDataFromForm(self.myID,"box");
//console.log(data);
//console.log(self.dragData.scaled);
//console.log(self.drawCoords);
			return self;
			},
...
//$("#mycoords").text("dragCrop toggleBoxControls X: " + e.pageX + ", Y: " + e.pageY);
...
//$("#mycoords").text(self.boxAction + " -> mouseMove X: " + e.pageX + ", Y: " + e.pageY); 
...
//$("#mycoords").text("stopCrop X: " + e.pageX + ", Y: " + e.pageY); 
							return false;
							});	
			...
			// EVENT_DBLCLICK	... EVENT_CLICK
				...
				/*
				self.$box.bind(EVENT_DBLCLICK,function( e ){
//console.log(e);
								self.togglePoints();
							return false;
							});
			...
			// EVENT_MOUSE_DOWN	comes before EVENT_CLICK
				...
				//self.$box.bind(EVENT_CLICK,function( e ){
					/*
				self.$box.bind(EVENT_MOUSE_DOWN,function( e ){
//console.log(e);
								self.startCrop(e);
//$("#mycoords").text("startCrop X: " + e.pageX + ", Y: " + e.pageY); 
							return false;
							});
							*/
...
//$("#mycoords").text("mouseMove X: " + e.pageX + ", Y: " + e.pageY); 
									// inside the box
									// at a point
									// outside the box 
							return false;
...
//console.log(" nx: " + nx + " ny: " + ny );	
		...
		bindCrop: function ( ) {
			var self = this;	
				...
				$(window).bind(EVENT_KEYDOWN,function(e){							
							self.bindCtrlZoom(e);
						// only returns false if the keys are pressed ... cntrl is prevented
						});	
		...
		bindNotCrop: function ( ) {
			var self = this;	
				/* BEGIN bind wheelZoom */
				$(window).bind(EVENT_WHEEL,function(e){
							self.bindWheelZoom(e);
						return false;
						});	
				...
				$(window).bind(EVENT_KEYDOWN,function(e){							
							self.bindCtrlZoom(e);
						// ... cntrl+/- is prevented and stop propagated
						return false;
						});	
				*/	
...
//console.log(data);	
//console.log("matching points:  self.myPoints");
...
//console.log("placePoint-> vertical: " + vertical + " horizontal: " + horizontal + " border: " + border+ " corner: " + corner);
//console.log(data);
//console.log(self.drawCoords);
...
//console.log("togglePoints->hasModal " + self.hasModal);
//console.log("togglePoints->isBoxVisible " + self.isBoxVisible);					
					if(self.hasModal)
						{
						if(self.isBoxVisible)
							{
...
console.log(data);				
		...
		bindCtrlZoom: function (e) {
			var self = this;
				if(self.options.enable.cntrlZoom)
					{
					var key = e.which || e.keyCode || 0;
					//if(self.isActive || self.isBoxActive)
						{
...
//console.log("+ has been pressed");
							...
							var zoomIncrement = self.options.zoom.cntrl;	
								var zoomFactor = self.zoomFactor + zoomIncrement;	
							var key = "cntrl-zoom-in";
							self.zoomTo(zoomFactor, key);  // this also sets self.zoomFactor
							self.updateConsole();
							self.cropVerify();
							}
						if(e.ctrlKey && (key == 109 || key == 189) )
							{
							e.preventDefault();
							e.stopPropagation();
//console.log("- has been pressed");
...
/*
	$.fn.cropMe = function( options ) {
		return this.each(function() {  // allows for multiple
			var instance = Object.create( cropMe );
					instance = instance.init( options, this );
			$.data( this, 'cropMe', instance );
		});
	};
	*/
	
	// http://www.iainjmitchell.com/blog/exposing-jquery-functions/
	...
	$.fn.cropMe = function( options ) {
		return this.each(function() {  // allows for multiple
			if (typeof arguments[0] === 'string') 
				{
				//execute string command on cropMe
...
$.fn[pluginName] = function ( options ) {
	...
	$.fn.cropMe = function() {
        if (typeof arguments[0] === 'string') {
            //execute string command on mediaPlayer
            var property = arguments[1];
            //remove the command name from the arguments
            var args = Array.prototype.slice.call(arguments);
				args.splice(0, 1);
...
onComplete: $.noop,
	...
	$.fn.cropMe.options = {
				...
				zoom:	{
						...
						cntrl:  0.1		// ratio if cntrlZoom is true
						}, 
				preview: {
				...
				box:	{
						...
						padding:  3,  // number of pixels (in container scaled units) to pad the box (this box goes over the top of the image container, acting as a modal, and extends beyond the image container ... if the corners of the cropping region are outside the container, on the edge, we can still drag them ... also enables us to have bindings of this modal layer different than the container layer ... mouseover, etc.)
				...
				console: {  // currently at least 600px wide ... width is based on modal overlay ... max-height is 300px
							...
							openImageInfo:  true,  // if autoOpen is true, this will also auto open
							openBoxInfo:  true, // if autoOpen is true, this will also auto open
...
//console.log("computeSwitch->" + mySwitch);
	...
	function getCropBoxCoords(self)
		...
		if(self.options.console.showControls)
			{
			var _x1 = parseFloat( $("#"+self.myID+"-box-x1")  	.val());
			var _x2 = parseFloat( $("#"+self.myID+"-box-x2")  	.val());
			var _y1 = parseFloat( $("#"+self.myID+"-box-y1")  	.val());
			var _y2 = parseFloat( $("#"+self.myID+"-box-y2")  	.val());
			}
			else
				{
					*/
	...
	function triggerComplete( e )  // when a user types in an input field, certain keys mean they are done
		...
		//if(e.ctrlKey || e.shiftKey || e.altKey || e.keyCode == 13 || e.keyCode == 9 || e.keyCode == 27 ) // don't want to e.preventDefault(); ... 
		var key = e.which || e.keyCode || 0;
		if(key == 13)
			{
			trigger = true;
